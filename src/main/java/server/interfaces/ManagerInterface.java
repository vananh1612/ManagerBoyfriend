...
public interface ManagerInterface<T> extends Remote {
     ...
     *                         từ xa.
     */
    Notification<T> create(T data) throws RemoteException, SQLException;
     ...
     */
    Notification<T> update(int id, T data) throws RemoteException, SQLException;
     ...
     */
    Notification<T> delete(int id) throws RemoteException, SQLException;
     ...
     */
    ArrayList<T> getAll() throws RemoteException, SQLException;
     ...
     */
    T getById(int id) throws RemoteException, SQLException;
     ...
     */
    ArrayList<T> getAllBy(String field, String value) throws RemoteException, SQLException;
     ...
     * @throws RemoteException nếu có vấn đề khi lấy dữ liệu theo field.
     */
    T getBy(String field, String value) throws RemoteException, SQLException;
     ...
     */
    ArrayList<T> search(String field, String value, boolean findAll) throws RemoteException, SQLException;
}
